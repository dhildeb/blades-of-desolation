...
const store = createStore({
  state: {
    // all monster stats: {name: 'any', race: '', img: '', spells: [], equipment: [], dmgType: '', hp: 5, magic: 0, luck: 0, strength: 1, dodge: 0, thorns: 0, actions: 1, physicalResistance: 0, magicResistance: 0, lifeSteal:  0, absorb: '', level: 1, loot: {gold: 0, items: []}, exp: 50}
      monsters: [
        //0
        [{name: 'goblin', actions: 1, strength: 2, hp: 7, loot: {gold: 5, items: ['dagger', 'health potion'], chance: [75, 5]}, exp: 50, dodge: 10, img: 'goblin-basic'},
        {name: 'trickster goblin', actions: 1, strength: 1, hp: 7, loot: {gold: 5, items: ['belt of tricks', 'health potion'], chance: [75, 5]}, dmgType: 'poison', statusEffects: [{name: 'poison', effect: 'hp', value: 1, chance: 5, negative: false}], exp: 50, dodge: 20, img: 'trickster-goblin'},
        {name: 'goblin archer', actions: 1, strength: 2, hp: 8, loot: {gold: 5, items: ['shortbow', 'health potion'], dgmType: 'ranged', chance: [75, 5]}, exp: 50, dodge: 10, img: 'goblin-archer'},
        {name: 'goblin sorcerer', actions: 1, strength: 3, hp: 6, loot: {gold: 5, items: ['wand', 'health potion', 'cape'], dgmType: 'fire', physicalResistance: 2, chance: [50, 5, 15]}, exp: 50, dodge: 10, img: 'sorcerer-goblin'},
        ...
        {name: 'bugbear', actions: 1, strength: 9, hp: 27, loot: {gold: 20, items: ['morningstar', 'health potion'], chance: [75, 10]}, exp: 200, img: 'bugbear'},
        {name: 'giant spider', actions: 1, dmgType: 'poison', statusEffects: [{name: 'poison', effect: 'hp', value: 2, chance: 20, negative: false}], immunities: ['poison'], vulnerabilities: ['fire'], strength: 16, hp: 26, loot: {gold: 20, items: ['health potion', 'antidote'], chance: [15, 15]}, exp: 200, img: 'giant-spider'},
        ...
        {name: 'shadow', actions: 1, strength: 9, lifeSteal: 50, physicalResistance: 50, absorb: 'necrotic', vulnerabilities: ['radiant'], immunities: ['petrify', 'poison'], dmgType: 'necrotic', hp: 16, loot: {gold: 10, items: [], chance: []}, exp: 100, img: 'shadow'},
        {name: 'scarecrow', actions: 2, strength: 6, immunities: ['petrify', 'poison'], physicalResistance: 20, hp: 36, loot: {gold: 20, items: [], chance: []}, exp: 200, img: 'scarecrow'},
        ...
        {name: 'nothic', race: 'aberration', img: 'nothic', dmgType: 'magic', vulnerabilities: ['radiant'], resistances: ['magic', 'necrotic'], hp: 45, strength: 8, actions: 2, level: 2, loot: {gold: 45, items: [], chance: []}, exp: 450},
        {name: 'ogre', race: 'giant', img: 'ogre', hp: 59, strength: 12, actions: 1, level: 2, loot: {gold: 45, items: ['greatclub', 'gauntlets of ogre power'], chance: [50, 5]}, exp: 450},
        ...
        {name: 'hyena', img: 'hyena', hp: 47, strength: 8, actions: 2, level: 2, loot: {gold: 45, items: [], chance: []}, exp: 450},
        {name: 'fairy', actions: 1, strength: 20, hp: 5, dmgType: 'magic', dodge: 75, loot: {gold: 56, items: [], chance: []}, exp: 450, img: 'fairy'},
        {name: 'goblin shaman', actions: 1, strength: 13, hp: 31, dmgType: 'necrotic', loot: {gold: 45, items: ['bone wand', 'health potion'], chance: [75, 5]}, exp: 450, dodge: 10, img: 'goblin-shaman'},
        {name: 'kreen', actions: 4, strength: 4, physicalResistance: 10, hp: 42, loot: {gold: 20, items: [], chance: []}, exp: 200, img: 'insect1'},
        ],
        //3
        [{name: 'displacer beast', dodge: 50, actions: 2, strength: 7, hp: 85, loot: {gold: 70, items: ['displacer cloak'], chance: [5]}, exp: 700, img: 'displacer-beast'},
        ...
        {name: 'mad golbin', actions: 1, strength: 15, hp: 45, statusEffects: [{name: 'poison', effect: 'hp', value: 10, chance: 15, negative: false}], loot: {gold: 70, items: ['health potion'], chance: [75]}, exp: 700, img: 'mad-goblin'},
        {name: 'spectator', actions: 2, strength: 16, hp: 39, absorb: 'magic', loot: {gold: 70, items: [], chance: []}, exp: 700, dmgType: 'magic', img: 'spectator'},
        ...
        {name: 'flameskull', actions: 2, strength: 10, hp: 40, loot: {gold: 110, items: ['mantle of spell resistance'], chance: [1]}, exp: 1100, absorb: 'magic', dmgType: 'magic', statusEffects: [{name: 'poison', effect: 'hp', value: 5, chance: 15, negative: false}, {name: 'petrify', effect: 'actions', value: 0, chance: 10, negative: false}], immunities: ['petrify'], img: 'flameskull'},
        {name: 'young phoenix', actions: 1, strength: 26, hp: 45, loot: {gold: 110, items: ['wand of fire', 'phoenix potion'], chance: [1, 1]}, exp: 1100, absorb: 'fire', dmgType: 'fire', physicalResistance: 50, img: 'pheonix'},
        ...
        {name: 'dark pegasus', actions: 4, strength: 14, hp: 98, dmgType: 'radiant', immunities: ['radiant'], loot: {gold: 180, items: [], chance: []}, exp: 1800, img: 'dark-pegasus'},
        ],
        //6
        [{name: 'sorcerer beast', actions: 1, strength: 45, hp: 60, loot: {gold: 230, items: ['wand of magic'], chance: [3]}, exp: 2300, dmgType: 'magic', statusEffects: [{name: 'poison', effect: 'hp', value: 10, chance: 10, negative: false}, {name: 'petrify', effect: 'actions', value: 0, chance: 10, negative: false}], img: 'sorcerer-beastman'},
        {name: 'beast warrior', actions: 3, strength: 15, hp: 112, loot: {gold: 230, items: ['morningstar', 'chain mail'], chance: [75, 25]}, exp: 2300, img: 'beast-warrior'},
        {name: 'rat warrior', actions: 2, strength: 21, hp: 85, loot: {gold: 230, items: ['scimitar'], chance: [75]}, exp: 2300, img: 'rat-warrior'},
        ...
        {name: 'witch', actions: 1, strength: 12, hp: 49, magicResistance: 25, dmgType: 'magic', statusEffects: [{name: 'poison', effect: 'hp', value: 5, chance: 15, negative: false}, {name: 'petrify', effect: 'actions', value: 0, chance: 15, negative: false}], loot: {gold: 230, items: [], chance: []}, exp: 2300, img: 'witch'},
        ],
        //7
        [{name: 'shield guardian', actions: 2, strength: 25, lifeSteal: 50, hp: 142, physicalResistance: 75, immunities: ['petrify', 'poison'], loot: {gold: 290, items: ['spear', 'longsword +1', 'shield +2'], chance: [75, 15, 5]}, exp: 2900, img: 'shield-guardian'},
        ...
        {name: 'shambling mound', actions: 2, strength: 21, hp: 236, statusEffects: [{name: 'poison', effect: 'hp', value: 4, chance: 20, negative: false}], loot: {gold: 290, items: [], chance: []}, thorns: 1, regen: 10, dmgType: 'poison', vulnerabilities: ['fire'], exp: 2900, img: 'shamble'},
        ...
        //8
        [{name: 'hydra', actions: 5, strength: 10, lifeSteal: 20, hp: 172, loot: {gold: 390, regen: 25, items: ['ring of regeneration']}, chance: [1], exp: 3900, img: 'hydra'},
        ...
        {name: 'sqix', actions: 3, strength: 16, hp: 176, resistances: ['fire'], vulnerabilities: ['lightning'], dodge: 15, loot: {gold: 390, items: [], chance: []}, exp: 3900, img: 'sqix'},
        ],
        //9
        ...
        {name: 'ice golem', actions: 3, strength: 25, absorb: 'cold', vulnerabilities: ['fire'], thorns: '10', dmgType: 'cold', hp: 481, loot: {gold: 720, items: [], chance: []}, exp: 7200, img: 'ice-golem'},
        ],
        //12
        ...
        {name: 'orc necromancer', actions: 2, strength: 25, hp: 575, lifesteal: 25, dmgType: 'necrotic', loot: {gold: 840, items: [], chance: []}, exp: 8400, img: 'orc-necromancer'},
        {name: 'yeti', actions: 1, strength: 34, hp: 2800, loot: {gold: 1300, items: [], chance: []}, statusEffects: [{name: 'petrify', effect: 'hp', value: 0, chance: 5, negative: false}], exp: 13000, dmgType: 'cold', absorb: 'cold', img: 'yeti'},
        ],
        //13
        ...
        {name: 'dark angel', actions: 2, strength: 38, hp: 2640, loot: {gold: 1000, items: [], chance: []}, magicResistance: 10, physicalResistance: 10, absorb: 'radiant', resistances: ['necrotic'], statusEffects: [{name: 'petrify', effect: 'actions', value: 0, chance: 10, negative: false}], lifeSteal: 20, dmgType: 'radiant', exp: 10000, img: 'dark-angel'},
        ],
        //14
        ...
        {name: 'yeti warrior', actions: 2, strength: 37, hp: 2800, loot: {gold: 1300, items: [], chance: []}, statusEffects: [{name: 'petrify', effect: 'hp', value: 0, chance: 15, negative: false}], exp: 13000, dmgType: 'cold', absorb: 'cold', img: 'yeti-warrior'},
        ],
        //16
        ...
        {name: 'tiamat', actions: 7, strength: 25, dmgType: 'magic', immunities: ['petrify', 'poison', 'acid', 'fire', 'cold', 'lightning', 'melee'], hp: 25550, loot: {gold: 2200, items: [], chance: []}, exp: 22000, img: 'tiamat'},
        ],
        //20
