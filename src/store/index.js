...
const store = createStore({
  state: {
    ...
    items: [
      // Common
      {name: 'shortsword', effect: 'strength', value: 2, type: 'mainHand', price: 400, rarity: 'c'},
      ...
      {name: 'battleaxe', effect: 'strength', value: 3, type: 'mainHand', price: 600, rarity: 'c', requirements: [{stat: 'baseStrength', req: 2}]},
      ...
      {name: 'gauntlets of ogre power', effect: 'strength', value: 3, type: 'accessory', price: 2000, rarity: 'uc', requirements: [{stat: 'baseHp', req: 15}]},
      ...
      {name: 'longsword +1', effect: 'strength', value: 10, type: 'mainHand', price: 5000, rarity: 'r', requirements: [{stat: 'baseStrength', req: 5}]},
      ...
      {name: 'defender', effect: ['strength', 'physicalResistance'], value: [10, 50], type: 'mainHand', price: 100000, rarity: 'l', requirements: [{stat: 'classType', req: 'paladin'}]},
      ...
      {name: 'sword of sharpness', effect: 'strength', value: 15, type: 'mainHand', price: 25000, rarity: 'vr', requirements: [{stat: 'baseStrength', req: 10}]},
      ...
      {name: 'sword of extra sharpness', effect: 'strength', value: 25, type: 'mainHand', price: 100000, rarity: 'l', requirements: [{stat: 'baseStrength', req: 15}]},
    ],
    abilities: [
