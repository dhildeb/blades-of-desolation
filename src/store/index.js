  ...
  state: {
    // all monster stats: {name: 'any', race: '', img: '', spells: [], equipment: [], dmgType: '', hp: 5, magic: 0, luck: 0, strength: 1, dodge: 0, thorns: 0, actions: 1, physicalResistance: 0, magicResistance: 0, lifeSteal:  0, absorb: '', level: 1, loot: {gold: 0, items: []}, exp: 50}
      monsters: [
        ...
        //2
        [{name: 'gelatinous cube', race: 'ooze', img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fgelatinous-cube.png?alt=media&token=c6d9255b-de4f-4fe8-9e5d-66464bd29119', immunities: ['petrify'], dmgType: 'acid', vulnerabilities: ['poison'], hp: 84, magic: 0, luck: 0, strength: 10, dodge: 0, thorns: 10, actions: 1, physicalResistance: 0, magicResistance: 0, lifeSteal: 25, absorb: 'acid', level: 2, loot: {gold: 45, items: []}, exp: 450},
    ...
    items: [
      ...
      {name: 'robe of the archmagi', effect: ['magicResistance', 'magic', 'physicalResistance'], value: [50, 10, 25], type: 'cloak', price: 100000, rarity: 'l', requirements: [{stat: 'baseMagic', req: 15}]},
