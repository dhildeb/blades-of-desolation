  ...
  state: {
    // all monster stats: {name: 'any', race: '', img: '', spells: [], equipment: [], dmgType: '', hp: 5, magic: 0, luck: 0, strength: 1, dodge: 0, thorns: 0, actions: 1, physicalResistance: 0, magicResistance: 0, lifeSteal:  0, absorb: '', level: 1, loot: {gold: 0, items: []}, exp: 50}
      monsters: [
        ...
        {name: 'giant spider', actions: 1, dmgType: 'poison', statusEffects: [{name: 'poison', effect: 'hp', value: 2, chance: 20, negative: false}], immunities: ['poison'], vulnerabilities: ['fire'], strength: 16, hp: 26, loot: {gold: 20, items: []}, exp: 200, img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fgiant-spider.png?alt=media&token=944f50cb-b41b-4865-9a28-9078cd65540c'},
        {name: 'imp', actions: 1, strength: 15, magicResistance: 25, physicalResistance: 25, hp: 10, absorb: 'fire', dmgType: 'fire', vulnerabilities: ['cold'], immunities: ['poison'], loot: {gold: 20, items: []}, exp: 200, img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fimp.png?alt=media&token=f2938d88-c399-4e6a-a6a4-1a99555bef25'},
        {name: 'multi-armed skeleton', actions: 4, strength: 3, hp: 26, loot: {gold: 20, items: []}, exp: 200, immunities: ['necrotic', 'psychic', 'petrify', 'poison'], vulnerabilities: ['radiant'], img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fmulti-armed-skeleton.png?alt=media&token=33e98e78-25d8-4582-aff0-55b2588178ef'},
        {name: 'myconid', actions: 2, strength: 8, hp: 22, dmgType: 'poison', statusEffects: [{name: 'poison', effect: 'hp', value: 4, chance: 10, negative: false}], immunities: ['poison'], loot: {gold: 10, items: []}, exp: 100, img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fmyconid.png?alt=media&token=d9a68eb5-6170-448f-a987-89cf76b27c95'},
        {name: 'ooze', actions: 1, strength: 11, hp: 22, thorns: 3, magicResistance: 25, dmgType: 'acid', immunities: ['acid', 'psychic', 'petrify'], vulnerabilities: ['poison'], loot: {gold: 10, items: []}, exp: 100, img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fooze.png?alt=media&token=6d011360-3e02-42f8-b960-1ad823fbd0ab'},
        ...
        {name: 'scarecrow', actions: 2, strength: 6, immunities: ['petrify', 'poison'], physicalResistance: 20, hp: 36, loot: {gold: 20, items: []}, exp: 200, img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fscarecrow.png?alt=media&token=b005ab31-b378-4cef-b1af-10fdf8ba91c2'},
        {name: 'pseudodragon', actions: 2, strength: 5, magicResistance: 25, physicalResistance: 25, hp: 30, dmgType: 'cold', resistances: ['cold', 'poison'], vulnerabilities: ['fire'], statusEffects: [{name: 'poison', effect: 'hp', value: 1, chance: 25, negative: false}], loot: {gold: 20, items: []}, exp: 200, img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fpseudodragon.png?alt=media&token=0e439993-9b35-42f0-99ff-9483d8bfbd25'},
        ],
        //2
        ...
        {name: 'nothic', race: 'aberration', img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fnothic.png?alt=media&token=a4f68856-cc22-45df-90ba-11e3142ab915', dmgType: 'magic', vulnerabilities: ['radiant'], resistances: ['magic', 'necrotic'], hp: 45, strength: 8, actions: 2, level: 2, loot: {gold: 45, items: []}, exp: 450},
        {name: 'ogre', race: 'giant', img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fogre.png?alt=media&token=dc59cd31-1642-455c-910c-989836b155eb', dmgType: '', hp: 59, strength: 12, actions: 1, level: 2, loot: {gold: 45, items: ['greatclub']}, exp: 450},
        ],
        //3
        ...
        {name: 'yuan-ti malison', actions: 2, strength: 10, absorb: 'poison', hp: 66, dmgType: 'poison', statusEffects: [{name: 'poison', effect: 'hp', value: 5, chance: 30, negative: false}], loot: {gold: 70, items: ['scimitar']}, exp: 700, img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fsnakeman.png?alt=media&token=5de8dc0d-7345-4ee3-9085-bf3e58b0b073'},
        ...
        //5
        [{name: 'barbed devil', actions: 3, strength: 10, hp: 110, loot: {gold: 180, items: []}, immunities: ['fire', 'poison'], exp: 1800, thorns: 5, img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fbarbed-devil.png?alt=media&token=b3c691e9-93f9-45ca-867d-30965616026a'},
        {name: 'flesh golem', actions: 2, strength: 13, hp: 93, loot: {gold: 180, items: []}, exp: 1800, absorb: 'lightning', immunities: ['petrify'], img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fflesh-golem.png?alt=media&token=4c36dfad-d0b6-434f-9fd9-97976ef0d97d'},
        ...
        //7
        [{name: 'shield guardian', actions: 2, strength: 25, lifeSteal: 50, hp: 142, physicalResistance: 75, immunities: ['petrify', 'poison'], loot: {gold: 290, items: ['spear', 'longsword +1']}, exp: 2900, img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fpngwing.com%20(71).png?alt=media&token=7ea84b7f-3825-4c13-8527-d1e8d1d58fb7'}
        ],
        //8
        ...
        {name: 'water elemental', actions: 1, dmgType: 'cold', strength: 50, hp: 208, vulnerabilities: ['lightning'], immunities: ['petrify', 'poison'], loot: {gold: 390, items: []}, exp: 3900, img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fwater-elemental.png?alt=media&token=0732233c-46dd-4710-b0ff-885adf1debb9'},
        ],
        //9
        ...
        //15
        [{name: 'baphomet', actions: 4, strength: 21, hp: 2750, loot: {gold: 1300, items: []}, exp: 13000, immunities: ['petrify'], img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fbaphomet.png?alt=media&token=187c94ae-a505-441a-8773-847c8755e127'}
        ],
        //16
        [{name: 'adult blue dragon', actions: 3, strength: 16, hp: 2250, loot: {gold: 1500, items: []}, immunities: ['petrify'], exp: 15000, dmgType: 'lightning', absorb: 'lightning', magicResistance: 50, physicalResistance: 25, statusEffects: [{name: 'petrify', effect: 'actions', value: 0, chance: 50, negative: false}], img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fblue-dragon.png?alt=media&token=edbedc28-1cce-43dc-9d9e-0ed92fbb24ed'}
        ],
        //17
        ...
        //18
        [{name: 'abyssal ooze', actions: 3, strength: 39, hp: 5740, loot: {gold: 2000, items: []}, immunities: ['petrify'], exp: 20000,thorns: 39, absorb: 'melee', dmgType: 'acid', img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fabyssal-ooze.png?alt=media&token=76919f5f-6822-439d-bd5c-2437fb3b5e8b'}
        ],
        //19
        ...
        //20
        [{name: 'death', actions: 10, strength: 100, hp: 1000000, loot: {gold: 2500, items: []}, immunities: ['petrify'], vulnerabilities: ['radiant'], absorb: 'necrotic', exp: 25000, img: 'https://firebasestorage.googleapis.com/v0/b/game-pics.appspot.com/o/monsters%2Fpngwing.com%20(79).png?alt=media&token=aa71a739-6b17-42d9-83fc-5d470623a567'}
        ]
    ],
    ...
    items: [
      ...
      {name: 'fire snake hide', effect: ['dmgType', 'thorns'], value: ['fire', 2], type: 'armor', price: 1400, rarity: 'uc'},
      ...
      {name: 'staff of fire', effect: ['magic', 'dmgType', 'resistances'], value: [10, 'fire', 'fire'], type: 'mainHand', speed: 2, price: 25000, rarity: 'vr', requirements: [{stat: 'classType', req: ['wizard', 'warlock']}]},
      {name: 'staff of frost', effect: ['magic', 'dmgType', 'resistances'], value: [10, 'cold', 'cold'], type: 'mainHand', speed: 2, price: 25000, rarity: 'vr', requirements: [{stat: 'classType', req: ['wizard', 'warlock']}]},
      {name: 'staff of force', effect: ['magic', 'dmgType', 'resistances'], value: [10, 'melee', 'melee'], type: 'mainHand', speed: 2, price: 25000, rarity: 'vr', requirements: [{stat: 'classType', req: ['wizard', 'warlock']}]},
      {name: 'staff of lightning', effect: ['magic', 'dmgType', 'resistances', 'statusEffects'], value: [10, 'lightning', 'lightning', {name: 'petrify', effect: 'actions', value: 0, chance: 25, negative: false}], type: 'mainHand', speed: 2, price: 25000, rarity: 'vr', requirements: [{stat: 'classType', req: ['wizard', 'warlock']}]},
      ...
      {name: 'robe of the archmagi', effect: ['magicResistance', 'magic', 'physicalResistance'], value: [25, 10, 25], type: 'cloak', price: 100000, rarity: 'l', requirements: [{stat: 'baseMagic', req: 15}]},
      {name: 'staff of the magi', effect: ['magic', 'absorb'], value: [10, 'magic'], type: 'mainHand', speed: 2, price: 100000, rarity: 'l', requirements: [{stat: 'classType', req: ['wizard', 'warlock']}]},
