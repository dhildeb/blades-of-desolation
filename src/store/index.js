...
const store = createStore({
  state: {
    ...
    items: [
      {name: 'shortsword', effect: 'strength', value: 2, type: 'mainHand', price: 400, requirements: [{stat: 'strength', req: 2}]},
      {name: 'dagger', effect: 'strength', value: 1, type: 'offHand', price: 200},
      {name: 'spear', effect: 'strength', value: 1, type: 'mainHand', price: 200},
      {name: 'shortbow', effect: 'strength', value: 1, type: 'mainHand', price: 200},
      {name: 'sticky shield', effect: 'baseHp', value: 3, type: 'offHand', price: 600},
      {name: 'battleaxe', effect: 'strength', value: 3, type: 'mainHand', price: 600},
      {name: 'greataxe', effect: 'strength', value: 6, requirements: [{stat: 'strength', req: 4}], price: 1200},
      {name: 'scimitar', effect: 'strength', value: 2, type: 'mainHand', price: 400},
      {name: 'handaxe', effect: 'strength', value: 1, type: 'mainHand', price: 200},
      {name: 'greatclub', effect: 'strength', value: 2, type: 'mainHand', price: 400},
      {name: 'morningstar', effect: 'strength', value: 2, type: 'mainHand', price: 400},
      {name: 'javelin', effect: 'strength', value: 1, type: 'mainHand', price: 200},
      {name: 'fire snake hide', effect: 'magicResistance', value: 20, type: 'armor', price: 400},
      {name: 'displacer cloak', effect: 'dodge', value: 25, type: 'cloak', price: 5000},
      {name: 'purple dragon scalemail', effect: 'baseHp', value: 50, type: 'armor', price: 10000},
      {name: 'red dragon scalemail', effect: 'baseHp', value: 50, type: 'armor', price: 10000},
    ],
    combatMonsters: [],
    player: {
      characters: [],
