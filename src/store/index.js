...
const store = createStore({
  state: {
    ...
    items: [
      ...
      {name: 'dagger of venom', effect: ['strength', 'dmgType'], value: [10, 'poison'], type: 'offHand', price: 10000, rarity: 'r', requirements: [{stat: 'classType', req: 'rogue'}]},
      ...
      {name: 'staff of lightning', effect: ['magic', 'dmgType', 'resistances'], value: [10, 'lightning', 'lightning'], type: 'mainHand', speed: 2, price: 25000, rarity: 'vr', requirements: [{stat: 'classType', req: ['wizard', 'warlock']}]},
      ...
      {name: 'sword of extra sharpness', effect: 'strength', value: 25, type: 'mainHand', speed: 2
