...
const store = createStore({
  state: {
    ...
    abilities: [
      ...
      {name: 'indomitable', level: 1, effect: ['physicalResistance'], value: [25], buff: true, temp: true, classType: 'fighter', uses: 1, baseUses: 1, description: 'Increase in physical resistance for a short time'}, 
      {name: 'fury of blows', level: 1, effect: ['hp'], value: [2], temp: false, buff: false, classType: 'monk', areaEffect: true, uses: 1, baseUses: 1, targetsEnemy: true, description: 'Quickly attack all enemies'}, 
      ...
      {name: 'laying on hands', level: 1, effect: ['hp'], value: [2], temp: false, buff: true, areaEffect: true, classType: 'paladin', uses: 1, baseUses: 1, description: 'Restores some of your party\'s hp'}, 
      {name: 'divine smite', level: 1, effect: ['strength', 'dmgType'], value: [5, 'radiant'], temp: true, buff: true, classType: 'paladin', uses: 1, baseUses: 1, description: 'Imbues attack with magical radiant dmg'}, 
